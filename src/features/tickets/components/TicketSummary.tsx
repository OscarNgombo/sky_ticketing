...
const TicketSummary: React.FC<TicketSummaryProps> = ({
  ...
  const summary = useMemo(() => {
    return {
      ...
      dropped: tickets.filter((t) => t.status.toLowerCase() === "dropped")
        .length,
      onHold: tickets.filter((t) => t.status.toLowerCase() === "on hold")
        .length,
    };
  }, [tickets]);
    ...
    <div className="ticket-summary">
      <div className="summary-list">
        <ul>
          ...
          <li
            className={`summary-item in-progress ${
          ...
          <li
            className={`summary-item resolved ${
          ...
          <li
            className={`summary-item dropped ${
              selectedStatus === "dropped" ? "active" : ""
            }`}
          ...
          <li
            className={`summary-item on-hold ${
              selectedStatus === "on hold" ? "active" : ""
            }`}
