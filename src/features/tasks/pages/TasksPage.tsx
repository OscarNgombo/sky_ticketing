...
import type {Column, TableFilter as TableFilterType, TableSort as TableSortType} from "../../tickets/components/Table";
...
import { AddIcon, SearchIcon, NotificationIcon, UserIcon } from "../../../shared/icons/icons";
...
export default function TasksPage() {
    ...
    const rightNavItems = useMemo(() => {
        ...
        if (isVendor) {
            items.push(
                <Dropdown key="sacco-filter" options={["Apstar SACCO", "Mwalimu SACCO", "Defence SACCO", "Wetu SACCO"]} value={saccoFilter} onChange={(e) => setSaccoFilter(e.target.value)} placeholder="Apstar SACCO Limited" showIcon={false} />
            );
        }
        items.push(
    ...
    }, [currentPage, serverSorts, serverFilters]);
